...
local USAGE = "usage is :Todoist, :Todoist <view>, :Todoist toggle, :Todoist capture or :Todoist task <id>"
...
vim.api.nvim_create_user_command("Todoist", function(cmd)
  ...
  range = true,
  complete = complete,
  desc = "Todoist: a list of tasks, a named view, the sidebar, a capture, or one task as a buffer",
})
